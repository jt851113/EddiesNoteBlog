<div align="center">
<h1>EddiesNoteBlog</h1>

[![Auth](https://img.shields.io/badge/Auth-eryajf-ff69b4)](https://github.com/eryajf)
[![Status](https://img.shields.io/badge/status-active-success.svg)](https://github.com/eryajf/EddiesNoteBlog)
[![GitHub Issues](https://img.shields.io/github/issues/eryajf/EddiesNoteBlog.svg)](https://github.com/eryajf/EddiesNoteBlog/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/eryajf/EddiesNoteBlog)](https://github.com/eryajf/EddiesNoteBlog/pulls)
[![GitHub Pull Requests](https://img.shields.io/github/stars/eryajf/EddiesNoteBlog)](https://github.com/eryajf/EddiesNoteBlog/stargazers)
[![GitHub license](https://img.shields.io/github/license/eryajf/EddiesNoteBlog)](https://github.com/eryajf/EddiesNoteBlog/blob/main/LICENSE)
[![HitCount](https://views.whatilearened.today/views/github/eryajf/EddiesNoteBlog.svg)](https://github.com/eryajf/EddiesNoteBlog)
[![website eryajf.github.io/EddiesNoteBlog](https://img.shields.io/website-up-down-green-red/http/eryajf.github.io/EddiesNoteBlog.svg)](https://eryajf.github.io/EddiesNoteBlog/)
...
首先访问模板仓库：[EddiesNoteBlog](https://github.com/eryajf/EddiesNoteBlog)。点击此仓库右侧的 `Use this template`
